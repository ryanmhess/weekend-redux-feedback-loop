            ...
            <form onSubmit={handleSubmit}>
                <FormControl>
                    ...
                    <RadioGroup row aria-labelledby="demo-row-radio-buttons-group-label" name="row-radio-buttons-group">
                        <FormControlLabel value="1" control={<Radio required/>} label="1" onChange={(event) => setSupported(event.target.value)}/>
                        <FormControlLabel value="2" control={<Radio  />} label="2" onChange={(event) => setSupported(event.target.value)}/>
                        <FormControlLabel value="3" control={<Radio  />} label="3" onChange={(event) => setSupported(event.target.value)}/>
                        <FormControlLabel value="4" control={<Radio  />} label="4" onChange={(event) => setSupported(event.target.value)}/>
                        <FormControlLabel value="5" control={<Radio  />} label="5" onChange={(event) => setSupported(event.target.value)}/>
                    </RadioGroup>
                </FormControl>
